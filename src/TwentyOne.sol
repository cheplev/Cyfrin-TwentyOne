...
contract TwentyOne {
    ...
    // @audit check all the logic here
    function call() public {
        ...
        // @audit magic numbers
        // @audit q should we check both dealer and player hands in first if?
        if (dealerHand > 21) {
            ...
            // @audit should we check that playerHand is not greater than 21?
            ...
            endGame(msg.sender, true);
            // @audit should we check that dealerHand is not greater than 21?
        } else {
